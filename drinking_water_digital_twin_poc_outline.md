...
│   │   ├── level_controller.gd
│   │   ├── flow_controller.gd
│   │   ├── equal_split_controller.gd
│   │   └── source_selection_controller.gd
│   │
│   └── tests/
│       ├── test_mass_balance.gd
│       ├── test_flow_limits.gd
│       ├── test_spill_logic.gd
│       └── test_distribution_logic.gd
│
├── plant/
│   ├── reservoirs/
│   ├── headworks/
...
├── data/
│   ├── default_plant.json
│   ├── default_setpoints.json
│   └── default_initial_conditions.json
│
└── docs/
    ├── PROJECT_SCOPE.md
    ├── PLANT_TOPOLOGY.md
